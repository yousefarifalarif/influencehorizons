...
INFLUENCERS = []
live_users = [{first_name: 'Kenzie', last_name: 'Jaylyn', password: "123456", phone_number: Faker::PhoneNumber.cell_phone_in_e164, location: "London", role: "Influencer" },
